// Učitavamo CSV fajl i prikazujemo podatke u tabeli i na grafikonima
window.addEventListener('DOMContentLoaded', function () {
  Papa.parse('data.CSV', {
    ...
    complete: function (results) {
      ...
      // Kreiramo grafikone za svaki senzor
...
// Mapiranje boja za providnu pozadinu
...
// Funkcija za prikaz cele tabele za proveru podataka
function displayFullTable(rows) {
  ...
  // Ima dva pritiska, pa ih posebno tretiramo
  const headerRow = rows[0];
  let pressureCount = 0;
  // Mape za prevod naslova kolona
